        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/90 leading-relaxed">
              We are proud to collaborate with leading companies that support
              our mission.
            </p>
          </motion.div>
        </div>
          ...
          <div className="bg-white shadow-lg rounded-xl p-8 max-w-4xl mx-auto transform transition duration-300 hover:scale-105">
            <div className="flex items-center space-x-4 mb-4">
              <img
                src={gimg}
                alt="Gamage Logo"
                className="w-16 h-16 rounded-full bg-black p-2 border-2 border-green-600"
              />
              <div>
                ...
                <div className="text-sm text-gray-600 flex items-center gap-4 mt-1">
                  ...
                  <a
                    ...
                    className="inline-flex items-center px-4 py-1.5 bg-emerald-600 text-white text-sm font-medium rounded-full shadow-md hover:bg-emerald-700 transition"
                  >
                    Visit Website
                  </a>
                </div>
            ...
            <p className="text-gray-700 mb-6">
              Gamage Recruiters is a Sri Lankan–based recruitment and talent
              acquisition company that specializes in connecting skilled
              professionals with top employers across various industries. With a
              strong focus on quality, professionalism, and personalized
              service, Gamage Recruiters supports both job seekers and
              organizations by offering tailored hiring solutions. Their goal is
              to bridge the gap between talent and opportunity, fostering growth
